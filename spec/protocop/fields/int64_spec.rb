...
describe Protocop::Fields::Int64 do
  ...
  describe "#encode" do
    ...
    context "when the field is not repeated" do
      ...
      let(:field) do
        described_class.new(:int64, :test, 1)
      end
    ...
    context "when the field is repeated" do
      ...
      context "when the field is not packed" do
        ...
        let(:field) do
          described_class.new(:int64, :test, 1, repeated: true)
        end
      ...
      context "when the field is packed" do
        ...
        let(:field) do
          described_class.new(:int64, :test, 1, repeated: true, packed: true)
        end

...
describe Protocop::Fields::Uint64 do
  ...
  describe "#encode" do
    ...
    context "when the field is not repeated" do
      ...
      let(:field) do
        described_class.new(:uint64, :test, 1)
      end
    ...
    context "when the field is repeated" do
      ...
      context "when the field is not packed" do
        ...
        let(:field) do
          described_class.new(:uint64, :test, 1, repeated: true)
        end
      ...
      context "when the field is packed" do
        ...
        let(:field) do
          described_class.new(:uint64, :test, 1, repeated: true, packed: true)
        end
